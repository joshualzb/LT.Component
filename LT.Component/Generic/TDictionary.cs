...
{
    [Serializable]
    public class TDictionary<TKey, TValue> : System.Collections.Generic.Dictionary<TKey, TValue>, ICustomCollection<KeyValuePair<TKey, TValue>>
    {
        #region 构造函数
        ...
        public int CompareTo(object obj)
        {
            ...
            {
                TDictionary<TKey, TValue> list = obj as TDictionary<TKey, TValue>;
